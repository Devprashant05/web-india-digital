...
<title>Web India Digital || Home</title>

<!-- Fav Icon -->
<link rel="icon" href="assets/images/favicon.ico" type="image/x-icon">

<!-- Google Fonts -->
<link href="../../css-7?family=Josefin+Sans:300,300i,400,400i,600,600i,700,700i&display=swap" rel="stylesheet">
<link href="../../css-8?family=Muli:300,300i,400,400i,500,500i,600,600i,700,700i,800,800i,900,900i&display=swap" rel="stylesheet">
...
<body class="boxed_wrapper">
            ...
            <div class="row clearfix align-items-center">
                <div class="col-xl-6 col-lg-12 col-md-12 offset-xl-6 content-column">
                    <div class="content-box">
                        <h1>Inspire Future <br>With Us</h1>
                        <p>At Web India Digital, we're dedicated to driving your success through strategic solutions and creative thinking.</p>
                        <a href="#" class="lightbox-image theme-btn style-ten"><span class="flaticon-next"></span>Request a Quote</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="welcome-section">
        <div class="auto-container">
            <div class="sec-title text-center">
                <p>Welcome to Web India Digital</p>
                <!--  where we fuel your business growth with tailored marketing solutions -->
                <h2>Where we fuel your business growth with<br>tailored marketing solutions</h2>
                    ...
                    <div class="welcome-block-one wow slideInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            ...
                            <div class="lower-content">
                                <h3><a href="#">User Prespective</a></h3>
                                <div class="text">
                                    <p>Solutions that resonate with your needs and aspirations.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 welcome-block">
                    <div class="welcome-block-one wow slideInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            ...
                            <div class="lower-content">
                                <h3><a href="#">Business Prespective</a></h3>
                                <div class="text">
                                    <p>Tailored solutions to amplify your brand and market presence.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 welcome-block">
                    <div class="welcome-block-one wow slideInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            ...
                            <div class="lower-content">
                                <h3><a href="#">Expert Prespective</a></h3>
                                <div class="text">
                                    <p>Crafted by seasoned professionals dedicated to your success.</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <!-- about-style-five -->
    <section class="about-style-five bg-color-1">
                    ...
                    <div id="content_block_10">
                        <div class="content-box">
                            <div class="sec-title text-left">
                                ...
                                <h2>Crafting Success Stories Through Innovative Marketing</h2>
                                <div class="decor" style="background-image: url(assets/images/icons/decor-1.png);"></div>
                            </div>
                            <div class="text">
                                <p>Our mission is to deliver professional, high-quality marketing services that are accessible and affordable. We envision a world where every business can thrive online.</p>
                            </div>
                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-6 col-md-6 col-sm-12 single-column">
                                        <div class="single-item">
                                            ...
                                            <p>Navigating diverse markets with a global perspective.</p>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12 single-column">
                                        <div class="single-item">
                                            ...
                                            <p>Investing in your success with measurable results as our priority.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="btn-box"><a href="about.php" class="theme-btn style-ten">Read More</a></div>
                        </div>
                    </div>
                </div>
    ...
    <section class="service-style-four">
        ...
        <div class="auto-container">
            <div class="sec-title text-center mb-30">
                <p>Our Services</p>
                <!-- Empower Your Business with Our Customized Services -->
                <h2>Empower Your Business with<br>Our Customized Services</h2>
                <div class="decor" style="background-image: url(assets/images/icons/decor-1.png);"></div>
            </div>
    ...
    <section class="porcess-style-three">
        ...
        <div class="auto-container">
            <div class="sec-title text-center light">
                ...
                <!-- Transforming Ideas into Success Stories, Step by Step -->
                <h2>Transforming Ideas into Success Stories,<br>Step by Step</h2>
                <div class="decor" style="background-image: url(assets/images/icons/decor-1.png);"></div>
            </div>
            <div class="inner-content">
                        ...
                        <div class="work-block-three">
                            <div class="inner-box">
                                ...
                                <div class="content-box wow slideInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                                    <h3><a href="index-2.html">Consultation & Planning</a></h3>
                                    <p>Aligning goals and objectives for a clear path forward.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="work-block-three">
                            <div class="inner-box">
                                ...
                                <div class="content-box wow slideInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                                    <h3><a href="index-2.html">Design & Development</a></h3>
                                    <p>Bringing ideas to life with expert development.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="work-block-three">
                            <div class="inner-box">
                                ...
                                <div class="content-box wow slideInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
                                    <h3><a href="index-2.html">Launch & Optimization</a></h3>
...
<section class="clients-style-two bg-color-1">
        ...
        <div class="auto-container">
            <div class="sec-title text-center style-two mb-70">
                <p>Clients</p>
                <h2>Our Clients: Partners in Success</h2>
                <div class="decor" style="background-image: url(assets/images/icons/decor-1.png);"></div>
            </div>
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-4 col-md-12 col-sm-12 thumb-column">
                                <div class="slider-pager">
                                    <div class="elipse-box">
                                        <div class="elipse elipse-1"></div>
                                    ...
                                    <ul class="thumb-box">
                                        ...
                                        <li>
                                            <a data-slide-index="1" href="#">
                                                <figure class="thumb thumb-2"><img src="assets/images/resource/testimonial-2.png" alt=""></figure>
                                            </a>                                       
                                        </li>
                                        <li>
                                            <a data-slide-index="2" href="#">
                                                <figure class="thumb thumb-3"><img src="assets/images/resource/thumb-2.png" alt=""></figure>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
    ...
    <!-- news-section -->
    <section class="news-section style-five">
        <div class="auto-container">
            <div class="sec-title text-left mb-60">
                <p>News & Updates</p>
